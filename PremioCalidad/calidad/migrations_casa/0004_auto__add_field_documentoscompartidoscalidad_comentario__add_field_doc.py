...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentosCompartidosCalidad.comentario'
        db.add_column(u'calidad_documentoscompartidoscalidad', 'comentario',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=350, blank=True),
                      keep_default=False)

        # Adding field 'DocumentosCompartidosMp.comentario'
        db.add_column(u'calidad_documentoscompartidosmp', 'comentario',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=350, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentosCompartidosCalidad.comentario'
        db.delete_column(u'calidad_documentoscompartidoscalidad', 'comentario')

        # Deleting field 'DocumentosCompartidosMp.comentario'
        db.delete_column(u'calidad_documentoscompartidosmp', 'comentario')
