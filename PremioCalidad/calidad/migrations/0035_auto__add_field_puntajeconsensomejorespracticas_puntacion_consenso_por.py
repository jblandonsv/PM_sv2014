...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PuntajeConsensoMejoresPracticas.puntacion_consenso_porcentual'
        db.add_column(u'calidad_puntajeconsensomejorespracticas', 'puntacion_consenso_porcentual',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


        # Changing field 'PuntajeConsensoMejoresPracticas.puntacion_consenso'
        db.alter_column(u'calidad_puntajeconsensomejorespracticas', 'puntacion_consenso', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2))

    def backwards(self, orm):
        # Deleting field 'PuntajeConsensoMejoresPracticas.puntacion_consenso_porcentual'
        db.delete_column(u'calidad_puntajeconsensomejorespracticas', 'puntacion_consenso_porcentual')


        # Changing field 'PuntajeConsensoMejoresPracticas.puntacion_consenso'
        db.alter_column(u'calidad_puntajeconsensomejorespracticas', 'puntacion_consenso', self.gf('django.db.models.fields.IntegerField')())
