...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CriteriosEvaluacion.integracion'
        db.delete_column(u'calidad_criteriosevaluacion', 'integracion')

        # Deleting field 'CriteriosEvaluacion.promedio'
        db.delete_column(u'calidad_criteriosevaluacion', 'promedio')

        # Deleting field 'CriteriosEvaluacion.enfoque'
        db.delete_column(u'calidad_criteriosevaluacion', 'enfoque')

        # Deleting field 'CriteriosEvaluacion.total'
        db.delete_column(u'calidad_criteriosevaluacion', 'total')

        # Deleting field 'CriteriosEvaluacion.aprendizaje'
        db.delete_column(u'calidad_criteriosevaluacion', 'aprendizaje')

        # Deleting field 'CriteriosEvaluacion.despligue'
        db.delete_column(u'calidad_criteriosevaluacion', 'despligue')


    def backwards(self, orm):
        # Adding field 'CriteriosEvaluacion.integracion'
        db.add_column(u'calidad_criteriosevaluacion', 'integracion',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'CriteriosEvaluacion.promedio'
        db.add_column(u'calidad_criteriosevaluacion', 'promedio',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=3, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'CriteriosEvaluacion.enfoque'
        db.add_column(u'calidad_criteriosevaluacion', 'enfoque',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'CriteriosEvaluacion.total'
        db.add_column(u'calidad_criteriosevaluacion', 'total',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=3, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'CriteriosEvaluacion.aprendizaje'
        db.add_column(u'calidad_criteriosevaluacion', 'aprendizaje',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'CriteriosEvaluacion.despligue'
        db.add_column(u'calidad_criteriosevaluacion', 'despligue',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)
