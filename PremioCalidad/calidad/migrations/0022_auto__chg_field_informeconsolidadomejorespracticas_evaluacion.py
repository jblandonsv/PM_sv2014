...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InformeConsolidadoMejoresPracticas.evaluacion'
        db.alter_column(u'calidad_informeconsolidadomejorespracticas', 'evaluacion_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calidad.EvaluacionConsensoMejoresPracticas']))

    def backwards(self, orm):

        # Changing field 'InformeConsolidadoMejoresPracticas.evaluacion'
        db.alter_column(u'calidad_informeconsolidadomejorespracticas', 'evaluacion_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calidad.EvaluacionConsensoCalidad']))
