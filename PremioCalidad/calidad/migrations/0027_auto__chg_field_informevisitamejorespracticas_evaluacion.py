...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InformeVisitaMejoresPracticas.evaluacion'
        db.alter_column(u'calidad_informevisitamejorespracticas', 'evaluacion_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calidad.EvaluacionVisitaMejoresPracticas']))

    def backwards(self, orm):

        # Changing field 'InformeVisitaMejoresPracticas.evaluacion'
        db.alter_column(u'calidad_informevisitamejorespracticas', 'evaluacion_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calidad.EvaluacionConsensoMejoresPracticas']))
