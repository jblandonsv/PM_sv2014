...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InformeConsolidadoCalidad.cuaderno'
        db.alter_column(u'calidad_informeconsolidadocalidad', 'cuaderno', self.gf('django.db.models.fields.files.FileField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'InformeConsolidadoCalidad.cuaderno'
        db.alter_column(u'calidad_informeconsolidadocalidad', 'cuaderno', self.gf('django.db.models.fields.files.FileField')(max_length=100))
