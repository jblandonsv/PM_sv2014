...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CriteriosEvaluacionConsensoCalidad'
        db.create_table(u'calidad_criteriosevaluacionconsensocalidad', (
        ...
        db.send_create_signal(u'calidad', ['CriteriosEvaluacionConsensoCalidad'])


    def backwards(self, orm):
        # Deleting model 'CriteriosEvaluacionConsensoCalidad'
        db.delete_table(u'calidad_criteriosevaluacionconsensocalidad')
    ...
    models = {
        ...
        u'calidad.criteriosevaluacionconsensocalidad': {
            'Meta': {'object_name': 'CriteriosEvaluacionConsensoCalidad'},
            'areas_mejorar': ('tinymce.models.HTMLField', [], {'blank': 'True'}),
            'criterio': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['calidad.CriteriosCalidad']"}),
