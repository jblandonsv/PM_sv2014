...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DocumentosCompartidosCalidad'
        db.create_table(u'calidad_documentoscompartidoscalidad', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('postulacion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calidad.PostulacionesCalidad'])),
            ('evaluador', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calidad.Evaluador'])),
            ('documento', self.gf('django.db.models.fields.files.FileField')(max_length=500, blank=True)),
        ...
        db.send_create_signal(u'calidad', ['DocumentosCompartidosCalidad'])

        # Adding model 'DocumentosCompartidosMp'
        db.create_table(u'calidad_documentoscompartidosmp', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('postulacion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calidad.PostulacionesMejoresPracticas'])),
            ('evaluador', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calidad.Evaluador'])),
            ('documento', self.gf('django.db.models.fields.files.FileField')(max_length=500, blank=True)),
            ('comentario', self.gf('django.db.models.fields.CharField')(max_length=350, blank=True)),
            ('fecha_subida', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'calidad', ['DocumentosCompartidosMp'])
        ...
        # Adding field 'EstadoPostulacionMejoresPracticas.finalizado'
        db.add_column(u'calidad_estadopostulacionmejorespracticas', 'finalizado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EstadoPostulacion.finalizado'
        db.add_column(u'calidad_estadopostulacion', 'finalizado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'DocumentosCompartidosCalidad'
        db.delete_table(u'calidad_documentoscompartidoscalidad')

        # Deleting model 'DocumentosCompartidosMp'
        db.delete_table(u'calidad_documentoscompartidosmp')
        ...
        # Deleting field 'EstadoPostulacionMejoresPracticas.finalizado'
        db.delete_column(u'calidad_estadopostulacionmejorespracticas', 'finalizado')

        # Deleting field 'EstadoPostulacion.finalizado'
        db.delete_column(u'calidad_estadopostulacion', 'finalizado')
