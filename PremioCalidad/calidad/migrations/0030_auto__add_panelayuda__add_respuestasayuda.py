...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'calidad.panelayuda': {
            'Meta': {'object_name': 'PanelAyuda'},
        ...
        u'calidad.respuestasayuda': {
            'Meta': {'object_name': 'RespuestasAyuda'},
            'caso': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['calidad.PanelAyuda']"}),
            'fecha': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
