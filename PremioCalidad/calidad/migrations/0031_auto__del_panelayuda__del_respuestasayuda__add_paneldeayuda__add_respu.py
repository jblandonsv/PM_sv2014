...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'PanelAyuda'
        db.delete_table(u'calidad_panelayuda')

        # Deleting model 'RespuestasAyuda'
        db.delete_table(u'calidad_respuestasayuda')

        # Adding model 'PanelDeAyuda'
        db.create_table(u'calidad_paneldeayuda', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('evaluador', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('asunto', self.gf('django.db.models.fields.CharField')(max_length=350)),
            ('caso', self.gf('tinymce.models.HTMLField')()),
            ('adjunto', self.gf('django.db.models.fields.files.FileField')(max_length=500, blank=True)),
            ('fecha', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('estado_caso', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'calidad', ['PanelDeAyuda'])

        # Adding model 'RespuestasDeAyuda'
        db.create_table(u'calidad_respuestasdeayuda', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('caso', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calidad.PanelDeAyuda'])),
            ('respuesta', self.gf('tinymce.models.HTMLField')()),
            ('fecha', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'calidad', ['RespuestasDeAyuda'])


    def backwards(self, orm):
        # Adding model 'PanelAyuda'
        db.create_table(u'calidad_panelayuda', (
            ('estado_caso', self.gf('django.db.models.fields.BooleanField')()),
            ('evaluador', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('adjunto', self.gf('django.db.models.fields.files.FileField')(max_length=500, blank=True)),
            ('fecha', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ...
        db.send_create_signal(u'calidad', ['PanelAyuda'])

        # Adding model 'RespuestasAyuda'
        db.create_table(u'calidad_respuestasayuda', (
            ('caso', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calidad.PanelAyuda'])),
            ('fecha', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('respuesta', self.gf('tinymce.models.HTMLField')()),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'calidad', ['RespuestasAyuda'])

        # Deleting model 'PanelDeAyuda'
        db.delete_table(u'calidad_paneldeayuda')

        # Deleting model 'RespuestasDeAyuda'
        db.delete_table(u'calidad_respuestasdeayuda')
    ...
    models = {
        ...
        u'calidad.paneldeayuda': {
            ...
            'evaluador': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
        ...
        u'calidad.puntajevisitacalidad': {
            ...
            'puntaje_maximo': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'puntaje_visita': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'})
        },
