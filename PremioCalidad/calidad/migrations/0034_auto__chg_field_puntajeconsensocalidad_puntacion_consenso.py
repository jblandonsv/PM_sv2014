...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PuntajeConsensoCalidad.puntacion_consenso'
        db.alter_column(u'calidad_puntajeconsensocalidad', 'puntacion_consenso', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'PuntajeConsensoCalidad.puntacion_consenso'
        db.alter_column(u'calidad_puntajeconsensocalidad', 'puntacion_consenso', self.gf('django.db.models.fields.IntegerField')())
