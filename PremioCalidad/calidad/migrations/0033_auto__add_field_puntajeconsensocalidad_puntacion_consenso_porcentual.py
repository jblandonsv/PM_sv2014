...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PuntajeConsensoCalidad.puntacion_consenso_porcentual'
        db.add_column(u'calidad_puntajeconsensocalidad', 'puntacion_consenso_porcentual',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PuntajeConsensoCalidad.puntacion_consenso_porcentual'
        db.delete_column(u'calidad_puntajeconsensocalidad', 'puntacion_consenso_porcentual')
