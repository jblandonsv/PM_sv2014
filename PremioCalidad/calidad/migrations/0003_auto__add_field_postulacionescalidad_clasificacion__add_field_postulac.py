...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PostulacionesCalidad.clasificacion'
        db.add_column(u'calidad_postulacionescalidad', 'clasificacion',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['calidad.TipoInstitucion']),
                      keep_default=False)

        # Adding field 'PostulacionesCalidad.representante_oficial'
        db.add_column(u'calidad_postulacionescalidad', 'representante_oficial',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=125, blank=True),
                      keep_default=False)

        # Adding field 'PostulacionesCalidad.representante_cargo'
        db.add_column(u'calidad_postulacionescalidad', 'representante_cargo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=125, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PostulacionesCalidad.clasificacion'
        db.delete_column(u'calidad_postulacionescalidad', 'clasificacion_id')

        # Deleting field 'PostulacionesCalidad.representante_oficial'
        db.delete_column(u'calidad_postulacionescalidad', 'representante_oficial')

        # Deleting field 'PostulacionesCalidad.representante_cargo'
        db.delete_column(u'calidad_postulacionescalidad', 'representante_cargo')
