...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'PanelDeAyuda.evaluador' to match new field type.
        db.rename_column(u'calidad_paneldeayuda', 'evaluador', 'evaluador_id')
        # Changing field 'PanelDeAyuda.evaluador'
        db.alter_column(u'calidad_paneldeayuda', 'evaluador_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
        # Adding index on 'PanelDeAyuda', fields ['evaluador']
        db.create_index(u'calidad_paneldeayuda', ['evaluador_id'])


    def backwards(self, orm):
        # Removing index on 'PanelDeAyuda', fields ['evaluador']
        db.delete_index(u'calidad_paneldeayuda', ['evaluador_id'])


        # Renaming column for 'PanelDeAyuda.evaluador' to match new field type.
        db.rename_column(u'calidad_paneldeayuda', 'evaluador_id', 'evaluador')
        # Changing field 'PanelDeAyuda.evaluador'
        db.alter_column(u'calidad_paneldeayuda', 'evaluador', self.gf('django.db.models.fields.CharField')(max_length=100))
