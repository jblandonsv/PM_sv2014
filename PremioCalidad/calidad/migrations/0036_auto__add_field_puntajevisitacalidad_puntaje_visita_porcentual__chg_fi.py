...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PuntajeVisitaCalidad.puntaje_visita_porcentual'
        db.add_column(u'calidad_puntajevisitacalidad', 'puntaje_visita_porcentual',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


        # Changing field 'PuntajeVisitaCalidad.puntaje_visita'
        db.alter_column(u'calidad_puntajevisitacalidad', 'puntaje_visita', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2))

        # Changing field 'PuntajeVisitaCalidad.puntaje_consenso'
        db.alter_column(u'calidad_puntajevisitacalidad', 'puntaje_consenso', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2))
        # Adding field 'PuntajeVisitaMejoresPracticas.puntacion_visita_porcentual'
        db.add_column(u'calidad_puntajevisitamejorespracticas', 'puntacion_visita_porcentual',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


        # Changing field 'PuntajeVisitaMejoresPracticas.puntacion_consenso'
        db.alter_column(u'calidad_puntajevisitamejorespracticas', 'puntacion_consenso', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2))

        # Changing field 'PuntajeVisitaMejoresPracticas.puntacion_visita'
        db.alter_column(u'calidad_puntajevisitamejorespracticas', 'puntacion_visita', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2))

    def backwards(self, orm):
        # Deleting field 'PuntajeVisitaCalidad.puntaje_visita_porcentual'
        db.delete_column(u'calidad_puntajevisitacalidad', 'puntaje_visita_porcentual')


        # Changing field 'PuntajeVisitaCalidad.puntaje_visita'
        db.alter_column(u'calidad_puntajevisitacalidad', 'puntaje_visita', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'PuntajeVisitaCalidad.puntaje_consenso'
        db.alter_column(u'calidad_puntajevisitacalidad', 'puntaje_consenso', self.gf('django.db.models.fields.IntegerField')())
        # Deleting field 'PuntajeVisitaMejoresPracticas.puntacion_visita_porcentual'
        db.delete_column(u'calidad_puntajevisitamejorespracticas', 'puntacion_visita_porcentual')


        # Changing field 'PuntajeVisitaMejoresPracticas.puntacion_consenso'
        db.alter_column(u'calidad_puntajevisitamejorespracticas', 'puntacion_consenso', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'PuntajeVisitaMejoresPracticas.puntacion_visita'
        db.alter_column(u'calidad_puntajevisitamejorespracticas', 'puntacion_visita', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'calidad.documentoscompartidoscalidad': {
            'Meta': {'object_name': 'DocumentosCompartidosCalidad'},
            'comentario': ('django.db.models.fields.CharField', [], {'max_length': '350', 'blank': 'True'}),
            'documento': ('django.db.models.fields.files.FileField', [], {'max_length': '500', 'blank': 'True'}),
            'evaluador': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['calidad.Evaluador']"}),
            'fecha_subida': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'postulacion': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['calidad.PostulacionesCalidad']"})
        },
        u'calidad.documentoscompartidosmp': {
            'Meta': {'object_name': 'DocumentosCompartidosMp'},
            'comentario': ('django.db.models.fields.CharField', [], {'max_length': '350', 'blank': 'True'}),
            'documento': ('django.db.models.fields.files.FileField', [], {'max_length': '500', 'blank': 'True'}),
            'evaluador': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['calidad.Evaluador']"}),
            'fecha_subida': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'postulacion': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['calidad.PostulacionesMejoresPracticas']"})
        },
        ...
        u'calidad.paneldeayuda': {
            'Meta': {'object_name': 'PanelDeAyuda'},
            'adjunto': ('django.db.models.fields.files.FileField', [], {'max_length': '500', 'blank': 'True'}),
            'asunto': ('django.db.models.fields.CharField', [], {'max_length': '350'}),
            'caso': ('tinymce.models.HTMLField', [], {}),
            'estado_caso': ('django.db.models.fields.BooleanField', [], {}),
            'evaluador': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
        ...
        u'calidad.puntajeconsensocalidad': {
            ...
            'puntacion_consenso': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '7', 'decimal_places': '2', 'blank': 'True'}),
            'puntacion_consenso_porcentual': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
        ...
        u'calidad.puntajevisitacalidad': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'puntaje_consenso': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '7', 'decimal_places': '2', 'blank': 'True'}),
            'puntaje_maximo': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'puntaje_visita': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '7', 'decimal_places': '2', 'blank': 'True'}),
            'puntaje_visita_porcentual': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'})
        },
        u'calidad.puntajevisitamejorespracticas': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'puntacion_consenso': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '7', 'decimal_places': '2', 'blank': 'True'}),
            'puntacion_visita': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '7', 'decimal_places': '2', 'blank': 'True'}),
            'puntacion_visita_porcentual': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'}),
            'puntaje_maximo': ('django.db.models.fields.IntegerField', [], {'blank': 'True'})
        },
        ...
        u'calidad.respuestasdeayuda': {
            'Meta': {'object_name': 'RespuestasDeAyuda'},
            'caso': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['calidad.PanelDeAyuda']"}),
            'fecha': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
