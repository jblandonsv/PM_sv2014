...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PostulacionesCalidad.direccion'
        db.add_column(u'calidad_postulacionescalidad', 'direccion',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=450, blank=True),
                      keep_default=False)

        # Adding field 'PostulacionesCalidad.web'
        db.add_column(u'calidad_postulacionescalidad', 'web',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True),
                      keep_default=False)

        # Adding field 'PostulacionesCalidad.telefono'
        db.add_column(u'calidad_postulacionescalidad', 'telefono',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Adding field 'PostulacionesCalidad.fax'
        db.add_column(u'calidad_postulacionescalidad', 'fax',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Adding field 'PostulacionesCalidad.ejecutivo'
        db.add_column(u'calidad_postulacionescalidad', 'ejecutivo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=75, blank=True),
                      keep_default=False)

        # Adding field 'PostulacionesCalidad.cargo_ejecutivo'
        db.add_column(u'calidad_postulacionescalidad', 'cargo_ejecutivo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=175, blank=True),
                      keep_default=False)

        # Adding field 'PostulacionesCalidad.telefono_ejecutivo'
        db.add_column(u'calidad_postulacionescalidad', 'telefono_ejecutivo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Adding field 'PostulacionesCalidad.fax_ejecutivo'
        db.add_column(u'calidad_postulacionescalidad', 'fax_ejecutivo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Adding field 'PostulacionesCalidad.email_ejecutivo'
        db.add_column(u'calidad_postulacionescalidad', 'email_ejecutivo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Adding field 'PostulacionesCalidad.contacto_nombre'
        db.add_column(u'calidad_postulacionescalidad', 'contacto_nombre',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=125, blank=True),
                      keep_default=False)

        # Adding field 'PostulacionesCalidad.contacto_cargo'
        db.add_column(u'calidad_postulacionescalidad', 'contacto_cargo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=175, blank=True),
                      keep_default=False)

        # Adding field 'PostulacionesCalidad.telefono_contacto'
        db.add_column(u'calidad_postulacionescalidad', 'telefono_contacto',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Adding field 'PostulacionesCalidad.fax_contacto'
        db.add_column(u'calidad_postulacionescalidad', 'fax_contacto',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Adding field 'PostulacionesCalidad.email_contacto'
        db.add_column(u'calidad_postulacionescalidad', 'email_contacto',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Adding field 'PostulacionesCalidad.contacto_alterno'
        db.add_column(u'calidad_postulacionescalidad', 'contacto_alterno',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=125, blank=True),
                      keep_default=False)

        # Adding field 'PostulacionesCalidad.cargo_alterno'
        db.add_column(u'calidad_postulacionescalidad', 'cargo_alterno',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=175, blank=True),
                      keep_default=False)

        # Adding field 'PostulacionesCalidad.telefono_alterno'
        db.add_column(u'calidad_postulacionescalidad', 'telefono_alterno',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Adding field 'PostulacionesCalidad.fax_alterno'
        db.add_column(u'calidad_postulacionescalidad', 'fax_alterno',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Adding field 'PostulacionesCalidad.email_alterno'
        db.add_column(u'calidad_postulacionescalidad', 'email_alterno',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PostulacionesCalidad.direccion'
        db.delete_column(u'calidad_postulacionescalidad', 'direccion')

        # Deleting field 'PostulacionesCalidad.web'
        db.delete_column(u'calidad_postulacionescalidad', 'web')

        # Deleting field 'PostulacionesCalidad.telefono'
        db.delete_column(u'calidad_postulacionescalidad', 'telefono')

        # Deleting field 'PostulacionesCalidad.fax'
        db.delete_column(u'calidad_postulacionescalidad', 'fax')

        # Deleting field 'PostulacionesCalidad.ejecutivo'
        db.delete_column(u'calidad_postulacionescalidad', 'ejecutivo')

        # Deleting field 'PostulacionesCalidad.cargo_ejecutivo'
        db.delete_column(u'calidad_postulacionescalidad', 'cargo_ejecutivo')

        # Deleting field 'PostulacionesCalidad.telefono_ejecutivo'
        db.delete_column(u'calidad_postulacionescalidad', 'telefono_ejecutivo')

        # Deleting field 'PostulacionesCalidad.fax_ejecutivo'
        db.delete_column(u'calidad_postulacionescalidad', 'fax_ejecutivo')

        # Deleting field 'PostulacionesCalidad.email_ejecutivo'
        db.delete_column(u'calidad_postulacionescalidad', 'email_ejecutivo')

        # Deleting field 'PostulacionesCalidad.contacto_nombre'
        db.delete_column(u'calidad_postulacionescalidad', 'contacto_nombre')

        # Deleting field 'PostulacionesCalidad.contacto_cargo'
        db.delete_column(u'calidad_postulacionescalidad', 'contacto_cargo')

        # Deleting field 'PostulacionesCalidad.telefono_contacto'
        db.delete_column(u'calidad_postulacionescalidad', 'telefono_contacto')

        # Deleting field 'PostulacionesCalidad.fax_contacto'
        db.delete_column(u'calidad_postulacionescalidad', 'fax_contacto')

        # Deleting field 'PostulacionesCalidad.email_contacto'
        db.delete_column(u'calidad_postulacionescalidad', 'email_contacto')

        # Deleting field 'PostulacionesCalidad.contacto_alterno'
        db.delete_column(u'calidad_postulacionescalidad', 'contacto_alterno')

        # Deleting field 'PostulacionesCalidad.cargo_alterno'
        db.delete_column(u'calidad_postulacionescalidad', 'cargo_alterno')

        # Deleting field 'PostulacionesCalidad.telefono_alterno'
        db.delete_column(u'calidad_postulacionescalidad', 'telefono_alterno')

        # Deleting field 'PostulacionesCalidad.fax_alterno'
        db.delete_column(u'calidad_postulacionescalidad', 'fax_alterno')

        # Deleting field 'PostulacionesCalidad.email_alterno'
        db.delete_column(u'calidad_postulacionescalidad', 'email_alterno')
    ...
    models = {
        ...
        u'calidad.postulacionescalidad': {
            ...
            'email_alterno': ('django.db.models.fields.CharField', [], {'max_length': '25', 'blank': 'True'}),
            'email_contacto': ('django.db.models.fields.CharField', [], {'max_length': '25', 'blank': 'True'}),
            'email_ejecutivo': ('django.db.models.fields.CharField', [], {'max_length': '25', 'blank': 'True'}),
